...
!(function (e, t) {
    ...
    function dd(e) {
      if (e || 0 === e) {
        ...
        (e = dd.v = Math.round(e) || (De && De.iOS ? 1 : 0)),
          ...
          (dd.cacheID = Ie.cache),
          t && o("ss", e);
      } else (n || Ie.cache !== dd.cacheID || o("ref")) && ((dd.cacheID = Ie.cache), (dd.v = r()));
    ...
    Ye = {
      ...
      sc: G(function (e) {
        return arguments.length
          ? Se.scrollTo(e, Fe.sc())
          : Se.pageXOffset || ke[n] || Pe[n] || Ee[n] || 0;
      }),
    },
    Fe = {
      s: a,
      ...
      sc: G(function (e) {
        return arguments.length
          ? Se.scrollTo(Ye.sc(), e)
          : Se.pageYOffset || ke[a] || Pe[a] || Ee[a] || 0;
      }),
    };
  (Ye.op = Fe), (Ie.cache = 0);
  var k =
    ((Observer.prototype.init = function init(e) {
      ...
      (this.target = o = J(o) || Pe),
        ...
        (n = !1 !== n),
        (r = r || parseFloat(Se.getComputedStyle(Ee).lineHeight) || 22);
      var ee,
        te,
        re,
        ne,
      ...
      (te = se._dc =
        ...
        (se.disable = function () {
          se.isEnabled &&
            ...
            se.isPressed &&
              (se._vx.reset(), se._vy.reset(), C(z ? o : be, Re[1], jf, !0)),
    ...
    function Ck(e, t, r, n, i) {
      ...
      return (
        ...
        (t.onComplete = function () {
          (Ck.tween = 0), a && a.call(o);
        }),
        (o = Ck.tween = He.to(c, t))
      );
    }
    var u = K(c, e),
      f = "_scroll" + e.p2;
    ...
    ne =
        ...
        if (
          ...
          if (
            ...
            ue &&
              ...
              (te = He.delayedCall(ue.delay || i / 2 || 0.1, function () {
                ...
                if (
                  ...
                  Ce.isActive && Ee !== e && te.restart(!0);
                else {
                  var n,
                    i,
                    o = (e - B) / N,
                    a = O && !ve ? O.totalProgress() : o,
                    s = t ? 0 : ((a - _) / (at() - Ue)) * 1e3 || 0,
            ...
            (I = this.markerStart = Db("start", a, u, he, e, t, 0, de)),
              ...
              de && (T = He.quickSetter([I, L], he.a, xt)),
              ye ||
          ...
          if (
              ...
              if ((!je && Ce.enabled) || t)
                if (ae && e && st) wb(ScrollTrigger, "scrollEnd", Ob);
                  ...
                  var i,
                    ...
                    P = (oe && Math.max(0, Ct.indexOf(Ce))) || 0,
                    E = P;
                  for (
                    _e &&
                    Va(r) &&
                    ...
                    (c = Ct[E]).end || c.refresh(0, 1) || (je = Ce),
                      !(u = c.pin) ||
                        (u !== oe && u !== ae && u !== k) ||
                        c.isReverted ||
                    ...
                    (i = mb(ae)),
                      ...
                      se
                        ? (((Z = [se + he.os2, N + _ + xt]).t = U),
                          (E = se === bt ? qb(ae, he) + N + _ : 0) &&
                            (Z.push(he.d, E + xt),
                            "auto" !== U.style.flexBasis &&
                              (U.style.flexBasis = E + xt)),
                          Mt(Z),
                          k &&
                            Ct.forEach(function (e) {
                              e.pin === k &&
            ...
            (Ce.getTrailing = function (t) {
              ...
              return (
                ...
                return 0 < Ce.direction ? e.end <= B : e.start >= q;
              });
            }),
            ...
            (Ce.enable = function (e, t) {
              Ce.enabled ||
                ...
                !1 !== e && ((Ce.progress = Oe = 0), (D = R = Ee = Ae())),
                !1 !== t && Ce.refresh());
            }),
      ...
      (ScrollTrigger.scrollerProxy = function scrollerProxy(e, t) {
        var r = J(e),
          ...
          i = La(r);
        ~n && Ie.splice(n, i ? 6 : 2),
          t && (i ? Le.unshift(Ne, t, Je, t, We, t) : Le.unshift(r, t));
      }),
  ...
  function Bc(e) {
    ...
    return (
      ...
      (e.onEnable = function () {
        uc(p, !f && "x"),
          ne.addEventListener("refresh", Kq),
          wb(Ne, "resize", Kq),
          b.smooth &&
      ...
      (e.onDisable = function () {
        uc(p, !0),
          xb(Ne, "resize", Kq),
          ne.removeEventListener("refresh", Kq),
          T.kill();
      }),
      ...
      e ||
        function (e, t) {
          return (
            ...
            (e.vars.containerAnimation ? 1e6 : e.start) -
            ((t.vars.containerAnimation ? 1e6 : t.start) +
